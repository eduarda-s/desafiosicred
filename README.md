...
# \- guia\_powerbi.md - documentação utilizada para construção do dashboard

# 

# dashboard/

# \- dashboard\_associados.pbix - dashboard final desenvolvido no Power BI
...
# A soma das três dimensões gera o SCORE\_TOTAL, que varia de 0 a 9.
...
# A flag criada na base é OPORT\_CROSS\_SELL.
...
# A flag criada na base é OPORT\_BAIXA\_UTILIZACAO.
...
# data/processed/base\_consolidada.xlsx
...
# \- Base\_Consolidada - base utilizada no Power BI;

# \- Resumo\_Classificacao - resumo dos indicadores por classificação;
...
# dashboard/dashboard\_associados.pbix
...
# Para visualizar o dashboard, abra dashboard/dashboard\_associados.pbix no Power BI Desktop.
